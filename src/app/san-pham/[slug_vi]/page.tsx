...
import { getAllProducts, getProductBySlug, getRelated, glossary, productDescription, translatedSpecHtml } from "@/lib/catalog";
  ...
  return <main className="detail-section">
    ...
    <section className="container-wokin product-layout">
      ...
      <div className="product-info">
        ...
        <div className="spec-html" dangerouslySetInnerHTML={{ __html: translatedSpecHtml(product.short_description) }} />
      </div>
    </section>
