...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "products" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"legacy_source_id" numeric NOT NULL,
	"sku" varchar,
	"name_vi" varchar NOT NULL,
	"slug_vi" varchar NOT NULL,
	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE UNIQUE INDEX "products_legacy_source_id_idx" ON "products" USING btree ("legacy_source_id");
  CREATE INDEX "products_sku_idx" ON "products" USING btree ("sku");
  CREATE UNIQUE INDEX "products_slug_vi_idx" ON "products" USING btree ("slug_vi");
